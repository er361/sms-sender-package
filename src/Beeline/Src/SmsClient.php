...
namespace Sf7kmmr\SmsService\Beeline\Src;
...
//        return $this->responseContent;
        ...
        // Debug flag
        $debug = env('APP_DEBUG'); // Установите в true для включения логирования
        ...
        if ($this->method === 'POST') {
            ...
            curl_setopt($this->ch, CURLOPT_CONNECTTIMEOUT, 30); // тайм-аут соединения, в секундах
